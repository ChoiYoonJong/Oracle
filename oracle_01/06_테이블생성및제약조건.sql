...
INSERT INTO USER_NOCONS
    ...
    VALUES
    (1, 'user01', 'pass01', '유재석','남','010-1234-5678','yu@uni.co.kr');
...
FROM SYS.USER_CONSTRAINTS UC
JOIN SYS.USER_CONS_COLUMNS UCC ON UC.CONSTRAINT_NAME = UCC.CONSTRAINT_NAME
WHERE UCC.CONSTRAINT_NAME = 'SYS_C007112';
...
INSERT INTO USER_UNIQUE2
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (1, NULL, 'pass01', '유재석','남','010-1234-5678','yu@uni.co.kr');
...
INSERT INTO USER_UNIQUE3
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (1, 'user02', 'pass01', '유재석','남','010-1234-5678','yu@uni.co.kr');

INSERT INTO USER_UNIQUE3
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (2, NULL, 'pass01', '유재석','남','010-1234-5678','yu@uni.co.kr');
...
INSERT INTO USER_CHECK
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (1, 'user01', 'pass01', '유재석','남자','010-1234-5678','yu@uni.co.kr');
    
SELECT
    UC.*,UCC.*
FROM SYS.USER_CONSTRAINTS UC
JOIN SYS.USER_CONS_COLUMNS UCC ON UC.CONSTRAINT_NAME = UCC.CONSTRAINT_NAME
WHERE UCC.CONSTRAINT_NAME = 'SYS_C007121';
...
INSERT INTO TEST_CHECK --오류 보고 - ORA-02290: check constraint (EMPLOYEE.CK_TEST_NUMBER) violated
    (TEST_NUMBER)
    VALUES
    (-10);
...
INSERT INTO USER_TEST
    ...
    VALUES
    (1, 'user01', 'pass01', '020202-1234567','남','010-1234-5674','서울특별시 강북구 동대문구 서로1-1','N');

INSERT INTO USER_TEST
    (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS,STATUS )
    VALUES
    (2, 'user02', 'pass02', '020210-2234567','여','010-1233-5678','서울특별시 강북구 동대문구 서로1-10','N');
INSERT INTO USER_TEST
    (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS,STATUS )
    VALUES
    (3, 'user03', 'pass03', '020410-1234567','남','010-1234-5671','서울특별시 강북구 동대문구 서로11-1','N');
INSERT INTO USER_TEST
    (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS,STATUS )
    VALUES
    (4, 'user04', 'pass04', '020302-2234567','여','010-1235-5672','서울특별시 강북구 동대문구 서로14-1','N');
INSERT INTO USER_TEST
    (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS,STATUS )
    VALUES
    (5, 'user05', 'pass05', '020510-1234567','남','010-1232-5679','서울특별시 강북구 동대문구 동로13-1','Y');
...
INSERT INTO USER_PRIMARYKEY -- ORA-00001: unique constraint (EMPLOYEE.PK_USER_NO) violated
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (1, 'user02', 'pass02', '유재석','남','010-1234-5678','yu@uni.co.kr');

INSERT INTO USER_PRIMARYKEY 
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (2, 'user02', 'pass02', '유재석','남','010-1234-5678','yu@uni.co.kr');

INSERT INTO USER_PRIMARYKEY -- ORA-01400: cannot insert NULL into ("EMPLOYEE"."USER_PRIMARYKEY"."USER_NO")
    (USER_NO, USER_ID, USER_PWD, USER_NAME, GENDER, PHONE, EMAIL)
    VALUES
    (NULL, 'user02', 'pass02', '유재석','남','010-1234-5678','yu@uni.co.kr');
...
CREATE TABLE USER_PRIMARYKEY2(
    ...
    PHONE VARCHAR2(30),
    EMAIL VARCHAR2(50),
    CONSTRAINT PK_USER_NO2 PRIMARY KEY(USER_NO, USER_ID) -- 테이블 레벨
);
...
SELECT
    ...
    A.GENDER 성별,
    A.PHONE 연락처,
    B.GRADE_NAME AS "회원 등급명"
FROM USER_FOREIGNKEY A, USER_GRADE B
...
NATURAL LEFT JOIN USER_GRADE B; -- NATURAL 앞에 붙이면 USING 도 사용안해도 된다.

--삭제 옵션 
--: 부모테이블의 데이터 삭제시 자식 테이블의 데이터를 어떤 식으로 처리할지에 대한 내용 설정
...
AS SELECT EMP_ID 사번, EMP_NAME 이름, SALARY 봉급, DEPT_TITLE 부서명, JOB_NAME 직급명
FROM EMPLOYEE
